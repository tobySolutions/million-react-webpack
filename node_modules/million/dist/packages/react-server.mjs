'use client';
import React$1, { useContext, useState, useRef, useEffect, createElement, Fragment, memo, forwardRef, useCallback, useLayoutEffect as useLayoutEffect$1 } from 'react';
import { S as SVG_RENDER_SCOPE, R as RENDER_SCOPE, b as useContainer, c as useNearestParent, r as renderReactScope } from '../shared/million.9efd57f2.mjs';
...
const SSRContext = React$1.createContext(defaultContext);
const IsSSRContext = React$1.createContext(false);
...
function useCounter(isDisabled = false) {
  ...
  if (ref.current === null && !isDisabled) {
    const currentOwner = React$1.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED?.ReactCurrentOwner?.current;
    if (currentOwner) {
...
const useSSRSafeId = typeof React$1.useId === "function" ? useModernSSRSafeId : useLegacySSRSafeId;
...
const block = (Component, options = {}) => {
  ...
  To avoid this error, \`experimental_options.noSlot\` should be false`)
    ...
    const vnode = createElement(
      ...
      rscBoundary ? createElement(rscBoundary, { ...props, ref }) : createSSRBoundary(
        Component,
        props,
        ref,
        noSlot,
